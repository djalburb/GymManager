...
namespace GymManager.Controllers
{
    public class PlanesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdPlan,Descripcion1,Descripcion2,CodigoAlterno,DuracionDias,Precio,Descuento")] Planes planes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPlan,Descripcion1,Descripcion2,CodigoAlterno,DuracionDias,Precio,Descuento")] Planes planes)
        {
            if (id != planes.IdPlan)
            {
                return NotFound();
